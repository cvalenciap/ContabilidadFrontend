...
trait StoreTrait
{
    ...
    public function getCompany()
    {
        return (new Company())
            ->setRuc('20536226231')
            ->setNombreComercial('L&K')
            ->setRazonSocial('INVERSIONES Y REPRESENTACIONES L&K S.A.C')
            ->setAddress((new Address())
                ->setUbigueo('150101')
                ->setDistrito('Villa Maria del Triunfo')
                ->setProvincia('LIMA')
                ->setDepartamento('LIMA')
                ->setUrbanizacion('-')
                ->setCodLocal('0000')
                ->setDireccion('Av. Pachacutec Nro. 3270 Micaela Bastidas (Alt.Paradero Coca Cola)'));
    }
